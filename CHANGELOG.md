...
- **Homepage hero**: Replaced bio card with newsletter subscription form. Buttons changed to "Read My Articles" and "View the Book" (links to /books).
...
- **Post generation prompt**: Shortened target to 500-600 words, fewer article formats, more human-like writing style.

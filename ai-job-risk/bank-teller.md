...
title: "AI Job Risk Audit: Bank Teller"
subtitle: "91% of traditional task load faces machine execution within 24 months"
share-title: "Bank Teller — AI Automation Risk Audit (91% Exposure)"
share-description: "Full forensic breakdown of AI automation risk for Bank Teller. Task-level analysis, timeline, disruption class, and career defense strategies for 2026-2028."
share-img: /assets/img/hasanjaffal.jpeg
permalink: /ai-job-risk/bank-teller/
automation_index: 91
disruption_class: "Full Asset Substitution"
keywords:
  - bank teller AI risk
  - will AI replace bank teller
  - bank teller automation
  - bank teller jobs 2028
  - AI replacing bank teller
---

## Executive Summary

The Bank Teller role carries a **91% automation index**, classified as **Full Asset Substitution**. The role does not evolve — it ends. There is no 'augmented' version. The economic incentive to retain the headcount drops to zero.
